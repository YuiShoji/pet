    ...
    <div class = signup_form>
      ...
      <div class =confirm>
        ...
        <form action="itemedit" method="post">
          <?php echo csrf_field(); ?>
          <input type="hidden" name="item_id" value="<?php echo e($post_data->item_id); ?>">
          ...
          <div class= item_edit_confirm_info>
            <table>
              ...
              <tr>
                ...
                <td style="border-bottom: none;"><p><?php echo nl2br(e($post_data->item_other)); ?></p></td>
              </tr>
...
<?php /**PATH C:\xampp\htdocs\pet\resources\views/item_edit_confirm.blade.php ENDPATH**/ ?>