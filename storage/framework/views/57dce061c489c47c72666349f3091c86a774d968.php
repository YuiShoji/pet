  ...
  <div class = main_wrap>
    <h5>items</h5>
      <div class=search_area>
        <table>
        <form id="item_search" name="signupForm" action="main" method="get">
        <tr>
          <th>カテゴリで絞込</th>
        </tr>
        <tr>
          ...
          <div class=img_area>
            <form method="get" action="view">
              <?php echo csrf_field(); ?>
                ...
                <input type="hidden" name="c_name" value="<?php echo e($item->c_name); ?>">
...
<?php /**PATH C:\xampp\htdocs\pet\resources\views/main.blade.php ENDPATH**/ ?>